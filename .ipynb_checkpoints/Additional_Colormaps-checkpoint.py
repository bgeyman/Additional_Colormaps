...
def make_colormap(path='./colormap_files/', filename='WhiteBlueGreenYellowRed.rgb', output_name='test'):
...
def load_all_NCL_cmaps():
    ...
    maps = {'ndvi': modis_ndvi, 'WBGYR': WBGYR, 'BGYORV':BGYORV, 'precip3_16lev':precip3_16lev,  
            ...
            'USGS_rainbow_16lev':USGS_16lev}
    
    return maps

def plot_NCL_cmap_example(cmap):
    """
